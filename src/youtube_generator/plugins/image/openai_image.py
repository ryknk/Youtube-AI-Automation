...
class OpenAIImageProvider(ImageProvider):
    def __init__(self, api_key: str, model: str, size: str, quality: str, retry_policy: RetryPolicy) -> None:
        self._generator = OpenAIImageGenerator(api_key, model, size, quality, retry_policy)
