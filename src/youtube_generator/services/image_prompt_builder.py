...
class ImagePromptBuilder:
    ...
    def build(self, scene_text: str) -> str:
        ...
        return (
            ...
            "frame. If the narration is abstract or conceptual rather than a concrete scene, choose "
            "one concrete, representative real-world setting that fits its mood and depict only "
            "that single setting.\n"
