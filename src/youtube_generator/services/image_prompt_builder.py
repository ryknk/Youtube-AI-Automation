...
class ImagePromptBuilder:
    ...
    def build(self, scene_text: str) -> str:
        ...
        return (
            ...
            "frame. If indoors, show a fully enclosed room with all walls, floor, and "
            "ceiling/roofline intact; any view to the outdoors must be through a proper window with "
            "a visible frame and glass, never an open gap. If outdoors, do not include indoor "
            "furniture or interior fixtures. If the narration is abstract or conceptual rather than "
            "a concrete scene, choose one concrete, representative real-world setting that fits its "
            "mood and depict only that single setting.\n"
