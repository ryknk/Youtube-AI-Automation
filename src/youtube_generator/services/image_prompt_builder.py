...
class ImagePromptBuilder:
    ...
    def build(self, scene_text: str) -> str:
        ...
        return (
            ...
            "enclosed room with all walls, floor, and ceiling/roofline intact, with any view to the "
            "outdoors only through a proper window with a visible frame and glass. If outdoors, show "
            "an open environment under the sky with no walls, ceiling, or indoor furniture. If the "
            "narration is abstract or conceptual rather than a concrete scene, choose one concrete, "
            "representative real-world setting that fits its mood and depict only that single "
            "setting.\n"
