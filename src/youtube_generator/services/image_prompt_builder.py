...
class ImagePromptBuilder:
    ...
    def build(self, scene_text: str) -> str:
        ...
        return (
            ...
            "frame. If indoors, show a single fully enclosed room, with walls and ceiling intact on "
            "every side, and any view to the outdoors only through a window set in a wall. If "
            "outdoors, do not include indoor furniture or interior fixtures. If the narration is "
            "abstract or conceptual rather than a concrete scene, choose one concrete, "
