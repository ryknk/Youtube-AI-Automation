...
class ImagePromptBuilder:
    ...
    def build(self, scene_text: str) -> str:
        ...
        return (
            ...
            "frame, matching whatever the narration actually describes. If indoors, show a fully "
            "enclosed room with all walls and a solid, unbroken ceiling/roofline (no openings, "
            "skylights, or holes); any view to the outdoors must be through a window set into a "
            "wall, with a visible frame and glass. If outdoors, show an open environment under the "
            "sky with no walls, ceiling, or indoor furniture. If the narration is abstract or "
            "conceptual rather than a concrete scene, choose one concrete, representative real-world "
            "setting that fits its mood and depict only that single setting.\n"
