...
class ImagePromptBuilder:
    ...
    def build(self, scene_text: str) -> str:
        ...
        return (
            ...
            "Setting: depict a single, physically coherent location for the entire image. Do not "
            "blend, juxtapose, or split the frame between multiple different locations (for "
            "example, do not combine an indoor office interior with an outdoor street scene in the "
            "same image). If the narration is abstract or conceptual rather than a concrete scene, "
            "choose one concrete, representative real-world setting and depict that single setting "
            "consistently across the entire frame.\n"
